...
function myFunction() {
    ...
    var urlxx = 'http://52.59.172.11:8080/AutomicREST-0.3-20170621-b1/api/awa/run/v1/Activities?token=rt02rhca03l6gl88luuf9q4h4n&name=DATABASE.ENTRIES.JOBP&alias=';
     var urLL = urlxx + urlx
